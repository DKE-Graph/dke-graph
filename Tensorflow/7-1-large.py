...
optimizer = tf.train.GradientDescentOptimizer(learning_rate=1.5).minimize(cost) # large learning rate
...
with tf.Session() as sess:
    ...
    for step in range(201):
        cost_val, W_val, _ = sess.run([cost, W, optimizer], feed_dict={X: x_data, Y: y_data}) # training data만 이용하여서 학습
