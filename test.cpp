...
//5,9,6,7,2,3,4,8
string node[num_of_node] = {server_ip,"192.168.4.10","192.168.4.9"};//,"192.168.4.10","192.168.4.9"};//, "192.168.4.10","192.168.4.9","192.168.4.8"};//,"192.168.4.16"};//,"192.168.1.106","192.168.1.107","192.168.1.108","192.168.1.109"};//"pod-b.svc-k8s-rdma","pod-c.svc-k8s-rdma","pod-d.svc-k8s-rdma","pod-e.svc-k8s-rdma"};//,"192.168.1.102","192.168.1.103"};
