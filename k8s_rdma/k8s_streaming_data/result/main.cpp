...
#define server_ip "pod-b.svc-k8s-streaming"

string node_domain[num_of_node] = {server_ip,"pod-c.svc-k8s-streaming","pod-d.svc-k8s-streaming","pod-e.svc-k8s-streaming"};
